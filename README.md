...
Open the relevant course README to find its lecture index. Each lecture README records the date, topics, source material, and completion status. The LaTeX source is compiled with `latexmk`.
